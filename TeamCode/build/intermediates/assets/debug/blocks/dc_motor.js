...
// Drive
Blockly.Blocks['drive_differentialTank'] = {
  init: function() {
    this.appendDummyInput()
        .appendField('call')
        .appendField(createNonEditableField('Drive'))
        .appendField('.')
        .appendField(createNonEditableField('TankDrive'));
    this.appendValueInput('LEFT_POWER').setCheck('Number')
        .appendField('Power')
        .appendField(createDcMotorDropdown(), 'IDENTIFIER1')
        .appendField('to')
        .setAlign(Blockly.ALIGN_RIGHT);
    this.appendValueInput('RIGHT_POWER').setCheck('Number')
        .appendField('Power')
        .appendField(createDcMotorDropdown(), 'IDENTIFIER2')
        .appendField('to')
        .setAlign(Blockly.ALIGN_RIGHT);
    this.appendValueInput('SQUARED_INPUTS').setCheck('Boolean')
        .appendField('squareInputs')
        .setAlign(Blockly.ALIGN_RIGHT);
    this.appendValueInput('DEADBAND').setCheck('Number')
        .appendField('deadband')
        .setAlign(Blockly.ALIGN_RIGHT);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setColour(functionColor);
    this.setTooltip('Tank drive function for a differential drive platform.');
  }
};

Blockly.JavaScript['drive_differentialTank'] = function(block) {
  var leftMotor = block.getFieldValue('IDENTIFIER1');
  var rightMotor = block.getFieldValue('IDENTIFIER2');
  var leftPower = Blockly.JavaScript.valueToCode(
      block, 'LEFT_POWER', Blockly.JavaScript.ORDER_COMMA);
  var rightPower = Blockly.JavaScript.valueToCode(
      block, 'RIGHT_POWER', Blockly.JavaScript.ORDER_COMMA);
  var squaredInputs = Blockly.JavaScript.valueToCode(
        block, 'SQUARED_INPUTS', Blockly.JavaScript.ORDER_COMMA);
  var deadband = Blockly.JavaScript.valueToCode(
        block, 'DEADBAND', Blockly.JavaScript.ORDER_COMMA);
  return leftMotor + '.driveDifferentialTank' + '(' + rightMotor + ', ' +
      leftPower + ', ' + rightPower + ', ' + squaredInputs + ', ' + deadband + ');\n';
};

Blockly.Blocks['drive_differentialCurvature'] = {
  init: function() {
    this.appendDummyInput()
        .appendField('call')
        .appendField(createNonEditableField('Drive'))
        .appendField('.')
        .appendField(createNonEditableField('CurvatureDrive'));
    this.appendDummyInput()
        .appendField('leftMotor')
        .appendField(createDcMotorDropdown(), 'IDENTIFIER1')
        .appendField('rightMotor')
        .appendField(createDcMotorDropdown(), 'IDENTIFIER2');
    this.appendValueInput('X_POWER').setCheck('Number')
        .appendField('xPower')
        .setAlign(Blockly.ALIGN_RIGHT);
    this.appendValueInput('Z_ROTATION_POWER').setCheck('Number')
        .appendField('zRotationPower')
        .setAlign(Blockly.ALIGN_RIGHT);
    this.appendValueInput('QUICK_TURN').setCheck('Boolean')
        .appendField('quickTurn')
        .setAlign(Blockly.ALIGN_RIGHT);
    this.appendValueInput('DEADBAND').setCheck('Number')
        .appendField('deadband')
        .setAlign(Blockly.ALIGN_RIGHT);
    ...
    // Assign 'this' to a variable for use in the tooltip closure below.
    this.setColour(functionColor);
    this.setTooltip('Curvature drive function for a differential drive platform.');
  }
};

Blockly.JavaScript['drive_differentialCurvature'] = function(block) {
  var leftMotor = block.getFieldValue('IDENTIFIER1');
  var rightMotor = block.getFieldValue('IDENTIFIER2');
  var xPower = Blockly.JavaScript.valueToCode(
      block, 'X_POWER', Blockly.JavaScript.ORDER_COMMA);
  var zRotationPower = Blockly.JavaScript.valueToCode(
      block, 'Z_ROTATION_POWER', Blockly.JavaScript.ORDER_COMMA);
  var quickTurn = Blockly.JavaScript.valueToCode(
        block, 'QUICK_TURN', Blockly.JavaScript.ORDER_COMMA);
  var deadband = Blockly.JavaScript.valueToCode(
        block, 'DEADBAND', Blockly.JavaScript.ORDER_COMMA);
  return leftMotor + '.driveDifferentialCurvature' + '(' + rightMotor + ', ' +
      xPower + ', ' + zRotationPower + ', ' + quickTurn + ', ' + deadband + ');\n';
};
