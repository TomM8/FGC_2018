...
var makeAlphanumeric = function(fileName) {
...
var uploadFile = function (localFile /*a File*/, url, success, failure) {
    ...
    var fileName = makeAlphanumeric(base) + ext;

    xhr.open("POST", url);
    xhr.setRequestHeader('Content-type', 'application/octet-stream');
    xhr.overrideMimeType('application/octet-stream');
    xhr.setRequestHeader('Content-Disposition', 'attachment; filename=' + '"' + fileName + '"');  // TODO: do we need to URI-encode this?
